...
def get_trouble(
    ...
    """특정 trouble을 조회합니다."""
    return service.get_trouble_by_id(trouble_id, x_user_id)
...
def update_trouble(
    ...
    """기존 trouble을 업데이트합니다."""
    return service.update_trouble(trouble_id, trouble_update_dto, x_user_id)
...
def delete_trouble(
    ...
    """trouble을 삭제합니다."""
    service.delete_trouble(trouble_id, x_user_id)
...
def get_project_troubles(
    ...
    return service.get_project_troubles(project_id, query_params, x_user_id)